...
let foxzyAPI = require('foxzy-api')
let foxzy = new foxzyAPI()
...
loghandler = {
    ...
    error: {
        status: 404,
        creator: `${creator}`,
        message: 'An internal error occurred. Please report via WhatsApp wa.me/6281386383559'
    }
}
    ...
    router.get('/igdl', async(req, res) => {
     ...
     router.get('/pindl', async(req, res) => {
      ...
      router.get('/nHentaiSearch', async (req, res) => {
            let query = req.query.query
            let hasil = await foxzy.search(query)
